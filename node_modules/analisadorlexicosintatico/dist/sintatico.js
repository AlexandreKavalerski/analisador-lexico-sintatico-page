...
function matchParentes(entrada) {
    return entrada[0].identificador === constants_1.DESC_TIPO_ABRE_PARENTESES && entrada[entrada.length - 1].identificador === constants_1.DESC_TIPO_FECHA_PARENTESES;
}
